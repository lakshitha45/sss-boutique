...
import { ArrowRight, Heart, Sparkles, Truck, CreditCard, Headphones, ShoppingBag, Eye, X } from "lucide-react";
import { CategoryCard, FadeIn, PageSection } from "@/components";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-end mb-10">
              <div className="space-y-1">
                <span className="text-[10px] text-accent font-bold uppercase tracking-[0.25em]">Latest Silhouettes</span>
            ...
            <div className="flex space-x-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-zinc-200 pr-4">
              {loading
                ...
                : newArrivals.map((prod) => {
                    ...
                    const prodImage = prod.images[0]?.imageUrl || "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=800&auto=format&fit=crop";
                    return (
                  ...
                  {fallbackFeatured[0] && (
                    <div className="group space-y-4">
                      <div className="aspect-[4/3] overflow-hidden bg-zinc-950 border border-zinc-150 relative">
                        <Image
                          src={fallbackFeatured[0].images[0]?.imageUrl || "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=800&auto=format&fit=crop"}
                ...
                <div className="lg:col-span-5 space-y-6">
                  {fallbackFeatured.slice(1, 3).map((prod) => (
                    <div key={prod.id} className="group border border-zinc-150 p-4 bg-[#121212]/30 flex items-center space-x-4">
                      <div className="w-24 h-32 overflow-hidden bg-zinc-50 border border-zinc-100 flex-shrink-0 relative">
                        <Image
